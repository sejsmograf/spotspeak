...
public class UserAchievementServiceIntegrationTest extends BaseServiceIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        traceCreationService = new TraceCreationService(traceRepository, resourceService, userService, tagService, eventPublisher);
        ...
        TestEntityFactory.createPersistedUserAchievement(entityManager, user, firstTraceAchievement, 0, 0, null);
        flushAndClear();
    }
...
//        UserActionEvent userActionEvent = new UserActionEvent(user, EEventType.ADD_TRACE, null, null);
//
...
//    }
    ...
    void shouldCompleteAchievement_whenUserAddsFirstTrace() {
        ...
        List<UserAchievementDTO> userAchievements = userAchievementService.getUserAchievements(user.getId().toString());
        ...
        UserAchievement firstTraceAchievement = userAchievementRepository.findById(firstTraceAchievementDTO.userAchievementId()).orElseThrow();
